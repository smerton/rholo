...
OBJECTS=main.o eos.o riemann.o matrix.o mesh.o shape.o timer.o quadrature.o polynomial.o
...
${EXEC}: ${OBJECTS}
	${MYCMP} ${MYFLAGS} ${MYINCS} -o $@ ${OBJECTS} ${SILO} ${HDF5} ${ZLIBS} ${MYLIBS} ${LAPACK} ${BLAS}
