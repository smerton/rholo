// Function definitions for members of the QuadratureRule class
// This class is used to create a quadrature rule to perform numerical integrations
//
// This was adapted from the following reference:
...
// constructor function for a new quadrature rule

QuadratureRule::QuadratureRule(int n){

// Constructor to instantiate a new quadrature rule with n integration points
//
// Arguments:
// n is a type int containing the number of integration points required

// assign the name of the rule
...
//  cout<<"QuadratureRule::QuadratureRule(): Building a "<<npoints<<" point quadrature rule"<<endl;

// assign the weights and abscissae

  x=new double[npoints];
  w=new double[npoints];

  cgqf ( npoints, kind, alpha, beta, a, b, x, w );

  return;

}

// Accessor function to return left end point
//
// Returns:
// type double containing the left end point of the quadrature domain

double QuadratureRule::GetL(){return a;}

// Accessor function to return right end point
//
// Returns:
// type double containing the right end point of the quadrature domain

double QuadratureRule::GetR(){return b;}

// The following member functions have been lifted from another code and
// use their own commentation scheme

void QuadratureRule::cdgqf ( int nt, int kind, double alpha, double beta, double t[], 
  double wts[] )
...
void QuadratureRule::cgqf ( int nt, int kind, double alpha, double beta, double a, double b, 
  double t[], double wts[] )
...
double QuadratureRule::class_matrix ( int kind, int m, double alpha, double beta, double aj[], 
  double bj[] )
...
void QuadratureRule::imtqlx ( int n, double d[], double e[], double z[] )
...
void QuadratureRule::parchk ( int kind, int m, double alpha, double beta )
...
double QuadratureRule::r8_epsilon ( )
...
double QuadratureRule::r8_sign ( double x )
...
void QuadratureRule::r8mat_write ( string output_filename, int m, int n, double table[] )
...
void QuadratureRule::rule_write ( int order, string filename, double x[], double w[], 
  double r[] )
...
void QuadratureRule::scqf ( int nt, double t[], int mlt[], double wts[], int nwts, int ndx[], 
...
void QuadratureRule::sgqf ( int nt, double aj[], double bj[], double zemu, double t[], 
  double wts[] )
